...
import { X, LayoutDashboard, ShirtIcon, ShoppingCart, RefreshCcw, Package, Heart, Users, UserCog, Building2, CreditCard, BarChart3 } from 'lucide-react';
...
export default function MobileMenu({ open, onClose }: MobileMenuProps) {
  ...
  const isAnyAdmin = isPlatformAdmin || user?.tipo === 'tenant_admin';
